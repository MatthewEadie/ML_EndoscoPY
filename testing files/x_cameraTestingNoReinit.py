...
class MainWindow(QWidget):
    def __init__(self):
        ...
        self.btnPlay = QPushButton('Snapshot')
        self.btnPlay.clicked.connect(self.snapshot)
        self.l.addWidget(self.btnPlay,1,1)

        self.btnPlay = QPushButton('Play')
        self.btnPlay.clicked.connect(self.playPressed)
        self.l.addWidget(self.btnPlay,2,1)

        self.btnStop = QPushButton('Stop')
        self.btnStop.clicked.connect(self.stopPressed)
        self.l.addWidget(self.btnStop,3,1)
